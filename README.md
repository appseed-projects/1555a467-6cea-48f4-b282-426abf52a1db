...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-09 20:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1555a467-6cea-48f4-b282-426abf52a1db.git
$ cd 1555a467-6cea-48f4-b282-426abf52a1db
```
